...
static void print_help(const char *argv0, FILE *out)
{
    fprintf(out,
            ...
            "  %s set-time <YYYY-MM-DD:hh:mm:ss> [--file PATH] [--notify]\n"
            "  %s reload [--file PATH]\n"
            ...
            "  set-time          set system clock + OFFSET (root, post-2038 safe)\n"
            ...
            "  sync              reload + optional --notify\n"
            "  notify            SIGHUP running y2k38 daemons\n"
            "\n"
